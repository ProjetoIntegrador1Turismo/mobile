...
import { InterestPointCard } from '../InterestPointCard/InterestPointCard';
...
export default function InterestPointCategoryDetails({ categoryTitle }: CategoryDetailsProps) {
  ...
  return (
    <View>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <InterestPointCard
            onPressCard={(id: number) => console.log(id)}
            data={item}
            className='mb-[10px]'
          />
        )}
