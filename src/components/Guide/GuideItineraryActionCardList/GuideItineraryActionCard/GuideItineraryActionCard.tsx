...
export function GuideItineraryActionCard({ imageCoverUrl, title, className }:GuideItineraryActionCardProps) {
 
  return (
    <View className='pl-4 pr-4'>
      <View className={cn('flex h-[160px] items-center justify-center overflow-hidden rounded-xl bg-gradient-to-b from-[#1C1C1E] to-black shadow-lg', className)}>
        <Image
