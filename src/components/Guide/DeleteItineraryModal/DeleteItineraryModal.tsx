      ...
      <View className='flex-1 items-center justify-center bg-black/90'>
        <View className='w-[80%] rounded-xl bg-[#1C1C1E] p-6'>
          ...
          <CustomText className='mb-6 text-center text-white' weight='regular' size={16}>
            Tem certeza que deseja excluir este roteiro? Esta ação não pode ser desfeita e você
          ...
          <View className='flex-row justify-center space-x-6'>
            ...
            <TouchableOpacity onPress={onConfirm} className='rounded-lg bg-red-500 px-8 py-3'>
