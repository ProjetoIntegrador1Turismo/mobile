...
import { useInterestPointCategoryListEditViewModel } from './InterestPointCategoryListEditViewModel';

export function InterestPointCategoryListEdit() {
  const { handleCategoryPress } = useInterestPointCategoryListEditViewModel();
