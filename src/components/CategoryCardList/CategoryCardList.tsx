...
import { CategoryCardData, onPressCategoryCard } from '~/src/components/CategoryCardList/CategoryCard/CategoryCardViewModel';
...
export function CategoryCardList() {
  ...
  return (
    <View className='min-w-[362px]'>
      <CustomText className='text-white mt-[30px]' size={36}>Categorias:</CustomText>
      <FlatList
